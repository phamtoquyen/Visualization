   ...
   ******************************************/
    ...
    function brushstart1() {
     ...
     function displayValues1() {
        ...
        var count = d3.selectAll("circle.selected").size();
        var selectedNode = d3.selectAll("circle.selected").data()[0];
        if (count === 1) {
             d3.select("#chart3")
                .select("#Cereal")
                .text(selectedNode.CerealName);
             d3.select("#chart3")
                .select("#Calories")
                .text(selectedNode.Calories);
             d3.select("#chart3")
                 .select("#FatValue")
                 .text(selectedNode.Fat);
             d3.select("#chart3")
               .select("#CarbValue")
               .text(selectedNode.Carb);
               d3.select("#chart3")
                .select("#FiberValue")
                .text(selectedNode.Fiber);
             d3.select("#chart3")
                .select("#ProteinValue")
                .text(selectedNode.Protein);
        }else {
            textClear();
        }
     }
   ...
   function displayValues2() {
        ...
        var count = d3.selectAll("circle.selected2").size();
        var selectedNode = d3.selectAll("circle.selected2").data()[0];
